  ...
  return (
    <div className="mb-10">
      <section className="text-gray-600 body-font">
        <div className="container xl:m-10 items-center justify-center flex flex-col">
          <div className="w-full">
            {/* <div class="rounded-lg h-64 overflow-hidden">
        <img alt="content" class="object-cover object-center h-full w-full" src="https://dummyimage.com/1200x500"/>
      </div> */}
            <div className="flex flex-col lg:flex-row mt-10 justify-center">
              <div className="lg:w-1/4 lg:text-center lg:pr-8 lg:py-8">
                {/* <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
        
          </div> */}
                <img src={"/assets/security.png"} className="ml-10" />
                <div className="flex flex-col lg:items-center lg:text-center md:justify-center ml-10 lg:ml-0">
                  <h2 className="font-bold mt-4 text-gray-700 text-3xl font-ubuntu">
                    Privacy policies
                  </h2>
              ...
              <div className="w-full px-4">
                <div className="row m-5">
                  <div className="col">
                    <h5 className="py-2 font-extrabold font-ubuntu text-gray-700">
                      Security
                    </h5>
                    <p className="font-light font-ubuntu text-gray-500">
